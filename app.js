...
function petStoreState (data) {
    state.pets = data.petfinder.pets.pet.map(function (pet){
        return {
            ...
            breed: pet.breeds.breed[0] === undefined ? 'Corgi' : pet.breeds.breed[0].$t 
        }
    }); 
    state.position = 0; 
...
function renderState () {
    ...
    var infoHTML = '<div style="display: inline-block"><a target="_blank" href="' + state.etsy.url + '">'  
...
// etsy api call 
var api_key = "poty2cxihe0j7gulkdiif6ez";
